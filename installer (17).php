...
namespace {
    ...
    class InstallerBootstrapData {
        const ARCHIVE_FILENAME       = '20230807_yourflowerstop_b6330b4dd4def48c3517_20230807102556_archive.zip';
        const ARCHIVE_SIZE           = '152422252';
        const INSTALLER_DIR_NAME     = 'dup-installer';
        const PACKAGE_HASH           = 'b6330b4-07102556';
        const SECONDARY_PACKAGE_HASH = '10cbf8d-07102556';
