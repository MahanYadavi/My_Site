...
class CachesPurge
{
    ...
    protected static function getPurgePlugins()
    {
        ...
        $items[] = new CacheItem(
            ...
            array('\\comet_cache', 'clear') // @phpstan-ignore-line
        );
        $items[] = new CacheItem(
            'Zen Cache',
            function () {
            ...
            array('\\zencache', 'clear') // @phpstan-ignore-line
        );
        $items[] = new CacheItem(
            'LiteSpeed Cache',
            function () {
        ...
        $items[] = new CacheItem(
            ...
            array('\\Breeze_PurgeCache', 'breeze_cache_flush') // @phpstan-ignore-line
        );
        $items[] = new CacheItem(
            'Swift Performance',
            function () {
            ...
            array('\\Swift_Performance_Cache', 'clear_all_cache') // @phpstan-ignore-line
        );
        $items[] = new CacheItem(
            'Hummingbird',
            function () {
        ...
        $items[] = new CacheItem(
            ...
            array('WPN_Helper', 'set_forms_maintenance_mode') // @phpstan-ignore-line
        );
        return $items;
    }
