...
class ParamFormSitesOwrMap extends ParamForm
{
    ...
    protected function sitesOrwHtml()
    {
        ...
        if (count($this->value) >= static::HARD_LIMIT_NUM_IMPORT) {
            $hardLimit = true;
        } elseif (count($this->value) >= static::SOFT_LIMIT_NUM_IMPORT) {
            $softLimit = true;
        }
        ...
        >
            ...
            <div class="overwrite_site_item add_item">
                ...
                <p class="overwrite_site_hard_limit_msg maroon <?php echo ($hardLimit ? '' : 'no-display');?>" >
                    ...
                    Maximum number of sites that can be imported in a single installation reached. (<?php echo static::HARD_LIMIT_NUM_IMPORT; ?>) 
    ...
    protected function getListExtraData()
    {
        if (is_null($this->extraData)) {
            ...
            $this->extraData = array(
                ...
                'softLimit' => static::SOFT_LIMIT_NUM_IMPORT,
                'hardLimit' => static::HARD_LIMIT_NUM_IMPORT
            );
